...
/**
 * @generated from protobuf message proto.UserResponse
 */
...
export interface NewPetRequest {
    ...
    name: string;
    /**
     * @generated from protobuf field: proto.Gender gender = 2;
     */
    gender: Gender;
    /**
...
export interface Pet {
    ...
    name: string;
    /**
     * @generated from protobuf field: proto.Gender gender = 3;
     */
    gender: Gender;
    /**
...
/**
 * @generated from protobuf enum proto.Gender
 */
export enum Gender {
    /**
...
/**
 * @generated MessageType for protobuf message proto.UserResponse
 */
...
class NewPetRequest$Type extends MessageType<NewPetRequest> {
    constructor() {
        super("proto.NewPetRequest", [
            ...
            { no: 2, name: "gender", kind: "enum", T: () => ["proto.Gender", Gender] },
...
class Pet$Type extends MessageType<Pet> {
    constructor() {
        super("proto.Pet", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "gender", kind: "enum", T: () => ["proto.Gender", Gender] },
...
/**
 * @generated ServiceType for protobuf service proto.UserService
 */
export const UserService = new ServiceType("proto.UserService", [
    { name: "WhoAmI", options: {}, I: Empty, O: UserResponse }
]);
